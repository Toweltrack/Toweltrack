<div class="modal fade" id="getInfo" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="get-info" role="form" method="post" action="contact.php">
	      <div class="modal-body">
	      	...
	      	<div class="form-group">
						...
						<input type="text" class="form-control" id="name" name="name" placeholder="First & Last Name" required autofocus>
					</div><!-- end .form-group -->
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="resort_name" name="resort_name" placeholder="Resort Name" required>
					</div><!-- end .form-group -->
